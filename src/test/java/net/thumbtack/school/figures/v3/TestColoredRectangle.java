...
public class TestColoredRectangle {
    ...
    public void testColoredRectangle1() throws ColorException {
        ...
        ColoredRectangle coloredRectangle = new ColoredRectangle(topLeft, bottomRight, Color.RED);
        assertAll(
    ...
    public void testColoredRectangle2() throws ColorException {
        Point topLeft = new Point(10, 20);
        Point bottomRight = new Point(30, 40);
        ColoredRectangle coloredRectangle = new ColoredRectangle(topLeft, bottomRight, "RED");
        assertAll(
                () -> assertEquals(10, coloredRectangle.getTopLeft().getX()),
                () -> assertEquals(20, coloredRectangle.getTopLeft().getY()),
                () -> assertEquals(30, coloredRectangle.getBottomRight().getX()),
    ...
    public void testColoredRectangle3() throws ColorException {
        ColoredRectangle coloredRectangle = new ColoredRectangle(10, 20, 30, 40, Color.RED);
        assertAll(
                () -> assertEquals(10, coloredRectangle.getTopLeft().getX()),
                () -> assertEquals(20, coloredRectangle.getTopLeft().getY()),
                () -> assertEquals(30, coloredRectangle.getBottomRight().getX()),
    ...
    public void testColoredRectangle4() throws ColorException {
        ColoredRectangle coloredRectangle = new ColoredRectangle(10, 20, 30, 40, "RED");
        assertAll(
                () -> assertEquals(10, coloredRectangle.getTopLeft().getX()),
                () -> assertEquals(20, coloredRectangle.getTopLeft().getY()),
                () -> assertEquals(30, coloredRectangle.getBottomRight().getX()),
    ...
    public void testColoredRectangle5() throws ColorException {
        ColoredRectangle coloredRectangle = new ColoredRectangle(10, 20, Color.RED);
        assertAll(
    ...
    public void testColoredRectangle6() throws ColorException {
        ColoredRectangle coloredRectangle = new ColoredRectangle(10, 20, "RED");
        assertAll(
                () -> assertEquals(0, coloredRectangle.getTopLeft().getX()),
                () -> assertEquals(-20, coloredRectangle.getTopLeft().getY()),
                () -> assertEquals(10, coloredRectangle.getBottomRight().getX()),
    ...
    public void testColoredRectangle7() throws ColorException {
        ColoredRectangle coloredRectangle = new ColoredRectangle(Color.RED);
        assertAll(
                () -> assertEquals(0, coloredRectangle.getTopLeft().getX()),
    ...
    public void testColoredRectangle8() throws ColorException {
        ColoredRectangle coloredRectangle = new ColoredRectangle("RED");
        assertAll(
                () -> assertEquals(0, coloredRectangle.getTopLeft().getX()),
                () -> assertEquals(-1, coloredRectangle.getTopLeft().getY()),
                () -> assertEquals(1, coloredRectangle.getBottomRight().getX()),
    ...
    @Test
    public void testColoredRectangle10() {
        assertThrows(ColorException.class, () -> new ColoredRectangle((Color) null));
    }

    @Test
    public void testColoredRectangle11() {
    ...
    @Test
    public void testIsPoint2DInsideColoredRectangle1() throws ColorException {
        ColoredRectangle coloredRectangle = new ColoredRectangle(10, 20, 30, 40, Color.RED);
        assertAll(
    ...
    @Test
    public void testIsPoint2DInsideColoredRectangle2() throws ColorException {
        ColoredRectangle coloredRectangle = new ColoredRectangle(10, 20, 30, 40, Color.RED);
        assertAll(
    ...
    public void testIsIntersectsColoredRectangle() throws ColorException {
        ColoredRectangle coloredRectangle = new ColoredRectangle(10, 20, 30, 40, Color.RED);
        assertAll(
                () -> assertTrue(coloredRectangle.isIntersects(new ColoredRectangle(15, 25, 25, 35, Color.RED))),
                () -> assertTrue(coloredRectangle.isIntersects(new ColoredRectangle(-10, 20, 30, 40, Color.RED))),
                () -> assertTrue(coloredRectangle.isIntersects(new ColoredRectangle(10, 20, 50, 40, Color.RED))),
                () -> assertTrue(coloredRectangle.isIntersects(new ColoredRectangle(-10, 20, 50, 40, Color.RED))),
                () -> assertTrue(coloredRectangle.isIntersects(new ColoredRectangle(10, -20, 30, 40, Color.RED))),
                () -> assertTrue(coloredRectangle.isIntersects(new ColoredRectangle(10, 20, 30, 60, Color.RED))),
                () -> assertTrue(coloredRectangle.isIntersects(new ColoredRectangle(-10, -20, 50, 60, Color.RED))),
                () -> assertTrue(coloredRectangle.isIntersects(new ColoredRectangle(0, 10, 20, 30, Color.RED))),
                () -> assertTrue(coloredRectangle.isIntersects(new ColoredRectangle(20, 30, 40, 50, Color.RED))),
                () -> assertFalse(coloredRectangle.isIntersects(new ColoredRectangle(-40, 20, -30, 40, Color.RED))),
                () -> assertFalse(coloredRectangle.isIntersects(new ColoredRectangle(110, 120, 130, 140, Color.RED))),
                () -> assertFalse(coloredRectangle.isIntersects(new ColoredRectangle(10, 120, 30, 140, Color.RED))),
                () -> assertFalse(coloredRectangle.isIntersects(new ColoredRectangle(10, -40, 30, -20, Color.RED)))
        );
    }
    ...
    public void testIsColoredRectangleInsideColoredRectangle() throws ColorException {
        ColoredRectangle coloredRectangle = new ColoredRectangle(10, 20, 30, 40, Color.RED);
        assertAll(
                () -> assertTrue(coloredRectangle.isInside(new ColoredRectangle(15, 25, 25, 35, Color.RED))),
                () -> assertFalse(coloredRectangle.isInside(new ColoredRectangle(-40, 20, -30, 40, Color.RED))),
                () -> assertFalse(coloredRectangle.isInside(new ColoredRectangle(110, 120, 130, 140, Color.RED))),
                () -> assertFalse(coloredRectangle.isInside(new ColoredRectangle(10, 120, 30, 140, Color.RED))),
                () -> assertFalse(coloredRectangle.isInside(new ColoredRectangle(10, -40, 30, -20, Color.RED)))
        );
    }

    @Test
    public void testEqualsColoredRectangle() throws ColorException {
        ColoredRectangle coloredRectangle1 = new ColoredRectangle(10, 20, 30, 40, Color.RED);
        ColoredRectangle coloredRectangle2 = new ColoredRectangle(10, 20, 30, 40, Color.RED);
        ColoredRectangle coloredRectangle3 = new ColoredRectangle(20, 30, 40, 50, Color.RED);
        ColoredRectangle coloredRectangle4 = new ColoredRectangle(10, 20, 30, 40, Color.GREEN);
    ...
    public void testAreaColoredRectangle() throws ColorException {
        ColoredRectangle coloredRectangle1 = new ColoredRectangle(10, 20, 30, 40, Color.RED);
        ColoredRectangle coloredRectangle2 = new ColoredRectangle(20, 30, 40, 80, Color.RED);
