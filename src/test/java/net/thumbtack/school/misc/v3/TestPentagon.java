...
public class TestPentagon {
    ...
    public void testPentagon() {
        ...
        pentagon.setPoint1(new Point(20, 10));
        pentagon.setPoint2(new Point(10, 20));
        pentagon.setPoint3(new Point(50, 50));
        pentagon.setPoint4(new Point(30, 60));
        pentagon.setPoint5(new Point(40, 20));
        assertAll(
                () -> assertEquals(20, pentagon.getPoint1().getX()),
                () -> assertEquals(10, pentagon.getPoint1().getY()),
                () -> assertEquals(10, pentagon.getPoint2().getX()),
                () -> assertEquals(20, pentagon.getPoint2().getY()),
                () -> assertEquals(50, pentagon.getPoint3().getX()),
                () -> assertEquals(50, pentagon.getPoint3().getY()),
                () -> assertEquals(30, pentagon.getPoint4().getX()),
                () -> assertEquals(60, pentagon.getPoint4().getY()),
                () -> assertEquals(40, pentagon.getPoint5().getX()),
                () -> assertEquals(20, pentagon.getPoint5().getY())
        );
    }
